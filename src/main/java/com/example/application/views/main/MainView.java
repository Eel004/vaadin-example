...
import com.example.application.backend.ui.CoronaDashboard;
import com.example.application.views.masterdetail.MasterDetailView;
import com.example.application.views.webcomponent.UsingWebComponentView;
...
public class MainView extends AppLayout {
    ...
    @PostConstruct
    public void init() {
        UI.getCurrent().getPage().executeJs("setInterval(function() {document.querySelectorAll('vaadin-license-box').forEach(box => box.style.display = 'none');}, 1000);");
    }
